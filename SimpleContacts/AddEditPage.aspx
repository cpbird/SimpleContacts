<%--
    This form I made for entering a new contact into the database. Uses code behind on save button event to insert into database and
    then redirects back to contact page. Validation for certain fields(email/phone/zip) occurs on client and server side.
--%>
